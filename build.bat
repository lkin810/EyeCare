@echo off
REM =============================================================
REM  EyeCare v6.0 Build Script (MSVC)
REM
REM  Usage:
...
cl /O2 /GL /EHsc /utf-8 /DUNICODE /D_UNICODE /MD EyeCare.cpp %RES_LIB% /link /SUBSYSTEM:WINDOWS user32.lib gdi32.lib advapi32.lib shell32.lib comctl32.lib winmm.lib gdiplus.lib ole32.lib
